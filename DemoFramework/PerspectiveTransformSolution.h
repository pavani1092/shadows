	...
	namespace Graphics
	{
		...
		public:
			...
			virtual void Apply()
			{
				...
				Matrix4 ortho = OrthoSolution(-10,10,-10,10,-10,20);
				Matrix4 transform = MatrixStack::projectionStack.top() * projection;
				Matrix4 depthproj = MatrixStack::orthographicStack.top()*ortho;
				MatrixStack::projectionStack.push(transform);
				MatrixStack::orthographicStack.push(depthproj);
			...
			virtual void Unapply()
			{
				...
				MatrixStack::orthographicStack.pop();
			}
			//
		...
		private:
			...
			Matrix4 OrthoSolution(float left, float right, float bottom, float top, float znear, float zfar)
			{
				float temp, temp2, temp3, temp4;
				temp = 2.0f;
				temp2 = right - left;
